  ...
  const steps = [
    {
      ...
      description:
        "Create your account and import contacts from Google, CSV, or add them manually.",
      color: "bg-blue-500",
    },
    {
      step: "02",
      ...
      title: "Organize & Tag",
      description:
        "Use tags, groups, and custom fields to organize your contacts exactly how you want.",
      color: "bg-green-500",
    },
    {
      step: "03",
      ...
      description:
        "Invite team members, assign contacts, and collaborate with role-based permissions.",
      color: "bg-purple-500",
    },
    {
      step: "04",
      ...
      title: "Automate & Grow",
      description:
        "Set reminders, sync with Google, and never miss important follow-ups again.",
      color: "bg-orange-500",
    },
  ];
              ...
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  <div className="relative mb-4">
                    <div
                      className={`flex h-16 w-16 items-center justify-center rounded-full ${step.color} text-white`}
                    >
